...
import com.Fair.GhostClient.Utils.Utils;
...
extends Utils.CFont {
    protected Utils.CFont.CharData[] boldChars = new Utils.CFont.CharData[256];
    protected Utils.CFont.CharData[] italicChars = new Utils.CFont.CharData[256];
    protected Utils.CFont.CharData[] boldItalicChars = new Utils.CFont.CharData[256];
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        Utils.CFont.CharData[] currentData = this.charData;
        ...
        if (render) {
            ...
            GlStateManager.bindTexture((int)this.tex.func_110552_b());
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (character == '\u00a7' && i < size) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        bold = true;
                        if (italic) {
                            GlStateManager.bindTexture((int)this.texItalicBold.func_110552_b());
                            currentData = this.boldItalicChars;
                        } else {
                            GlStateManager.bindTexture((int)this.texBold.func_110552_b());
                        ...
                        if (bold) {
                            ...
                            GlStateManager.bindTexture((int)this.texItalic.func_110552_b());
