...
public class HUDUtils {
    ...
    public static void re(BlockPos bp, int color, boolean shade) {
        if (bp != null) {
            double x = (double)bp.func_177958_n() - HUDUtils.mc.getRenderManager().viewerPosX;
            double y = (double)bp.func_177956_o() - HUDUtils.mc.getRenderManager().viewerPosY;
            double z = (double)bp.func_177952_p() - HUDUtils.mc.getRenderManager().viewerPosZ;
            GL11.glBlendFunc((int)770, (int)771);
            GL11.glEnable((int)3042);
