...
extends Module {
    ...
    private IntegerSetting LeftMinCPS = new IntegerSetting("MinCPS", 9.0, 1.0, 30.0);
    private IntegerSetting LeftMaxCPS = new IntegerSetting("MaxCPS", 13.0, 1.0, 30.0);
    private EnableSetting Right_Click = new EnableSetting("Right Click", false);
    private IntegerSetting RightMinCPS = new IntegerSetting("RightMinCPS", 12.0, 1.0, 30.0);
    private IntegerSetting RightMaxCPS = new IntegerSetting("RightMaxCPS", 15.0, 1.0, 30.0);
    private EnableSetting Break_Blocks = new EnableSetting("Break Blocks", true);
    private IntegerSetting BreakDelay = new IntegerSetting("Break Delay", 25.0, 0.0, 1000.0);
    ...
    private IntegerSetting JitterLeft = new IntegerSetting("JitterLeft", 0.0, 0.0, 3.0);
    private IntegerSetting JitterRight = new IntegerSetting("JitterRight", 0.0, 0.0, 3.0);
    private IntegerSetting rightClickDelay = new IntegerSetting("rightClickDelay", 85.0, 0.0, 500.0);
    ...
    public AutoClicker() {
        super("AutoClicker", 0, Category.Combat, false, "AC");
