...
extends Module {
    ...
    public static void renderChest(BlockPos blockPos) {
        double d0 = (double)blockPos.func_177958_n() - Minecraft.getMinecraft().getRenderManager().viewerPosX;
        double d1 = (double)blockPos.func_177956_o() - Minecraft.getMinecraft().getRenderManager().viewerPosY;
        double d2 = (double)blockPos.func_177952_p() - Minecraft.getMinecraft().getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
        ...
        ChestESP.glColor(CategoryPanel.getColor());
        RenderGlobal.drawSelectionBoundingBox((AxisAlignedBB)new AxisAlignedBB(d0, d1, d2, d0 + 1.0, d1 + 1.0, d2 + 1.0));
    ...
    public static void re(BlockPos bp, int color) {
        ...
        double x = (double)bp.func_177958_n() - ChestESP.getRenderPosX();
        double y = (double)bp.func_177956_o() - ChestESP.getRenderPosY();
        double z = (double)bp.func_177952_p() - ChestESP.getRenderPosZ();
        GL11.glBlendFunc((int)770, (int)771);
        GL11.glEnable((int)3042);
