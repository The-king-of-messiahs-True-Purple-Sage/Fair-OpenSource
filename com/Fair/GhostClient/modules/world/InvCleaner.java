...
extends Module {
    private IntegerSetting BlockCap = new IntegerSetting("MaxBlocks", 128.0, 0.0, 256.0);
    ...
    private IntegerSetting Delay = new IntegerSetting("Delay", 50.0, 0.0, 1000.0);
    ...
    public void shiftClick(int slot) {
        InvCleaner.mc.playerController.windowClick(InvCleaner.mc.thePlayer.inventoryContainer.windowId, slot, 0, 1, (EntityPlayer)InvCleaner.mc.thePlayer);
    }

    public void swap(int slot1, int hotbarSlot) {
        InvCleaner.mc.playerController.windowClick(InvCleaner.mc.thePlayer.inventoryContainer.windowId, slot1, hotbarSlot, 2, (EntityPlayer)InvCleaner.mc.thePlayer);
    }

    public void drop(int slot) {
        InvCleaner.mc.playerController.windowClick(InvCleaner.mc.thePlayer.inventoryContainer.windowId, slot, 1, 4, (EntityPlayer)InvCleaner.mc.thePlayer);
    }
